...
主方法保持：大样本肿瘤组织 RNA 表达构建癌种特异 ARACNe3 网络，`viper` 包将网络转为 regulon，VIPER/aREA 计算逐样本 TF 活性，msVIPER 检验组间差异活性。调控因子使用 TNBC Supplementary Data 2 中 PAN-GO “regulators of transcription”清单。
...
2. PAN-GO 清单成功提取 2,139 个唯一非空 gene symbols，且其中至少 1,500 个进入 ARACNe3；
