...
> **状态更正（2026-08-16）**：本报告的 TCGA 发现结果仍有效，但 GSE81089 分支及其衍生的“97 个复现 TF”、跨系统 97-TF 程序和 Figure 1/Supplementary Figure 1–2 对应图表暂定，不能继续视为最终冻结结果。原因是样本别名未处理导致 2 例 LUAD 被静默漏纳（现用 106/67，应为 108/67）。此外，当前外部患者验证仍是 RNA-seq 同平台验证，尚未补齐 TNBC 锚点中 METABRIC 所承担的独立 microarray 跨平台验证。须完成别名修复、GSE81089 重跑和微阵列验证后再发布修订版最终报告；Figure 2 仍按全部 158 个 TCGA 发现 TF 继续，未受影响。
